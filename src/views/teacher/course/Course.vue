        ...
        <div class="iq-card-body">
          <form @submit.prevent="addCourse">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input
                    ...
                    @input="validateForm, formatPrice($event.target.value)"
                  />
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="bathrooms">Công nghệ sử dụng</label>
                  <Multiselect
...
const addCourse = async () => {
  ...
  try {
    ...
    toast.error('Có lỗi xảy ra: ' + (error.response?.data?.message || 'Không thể tạo khóa học'), {
      position: 'top-right',
      autoClose: 3000,
    })
