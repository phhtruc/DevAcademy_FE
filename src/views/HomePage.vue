    ...
    <div class="container-fluid">
          ...
          <div class="iq-card iq-card-block iq-card-stretch iq-card-height overflow-hidden">
            <div class="iq-card-body pb-0">
              ...
              <div class="text-center">
                ...
                <p class="mb-0 text-secondary line-height">
                  <i class="ri-arrow-up-line text-success mr-1"></i
                  ><span class="text-success">20%</span> Increased
                </p>
              </div>
            </div>
            <div id="chart-2"></div>
          ...
          <div class="iq-card iq-card-block iq-card-stretch iq-card-height overflow-hidden">
            <div class="iq-card-body pb-0">
              ...
              <div class="text-center">
                ...
                <p class="mb-0 text-secondary line-height">
                  <i class="ri-arrow-up-line text-success mr-1"></i
                  ><span class="text-success">30%</span> Increased
                </p>
              </div>
            </div>
            <div id="chart-3"></div>
          ...
          <div class="iq-card iq-card-block iq-card-stretch iq-card-height overflow-hidden">
            <div class="iq-card-body pb-0">
              ...
              <div class="text-center">
                ...
                <p class="mb-0 text-secondary line-height">
                  <i class="ri-arrow-down-line text-danger mr-1"></i
                  ><span class="text-danger">10%</span> Increased
                </p>
              </div>
            </div>
            <div id="chart-4"></div>
          ...
          <div class="iq-card iq-card-block iq-card-stretch iq-card-height animation-card">
            <div class="iq-card-body p-0">
              ...
              <div class="an-img">
                <div
                  class="bodymovin"
                  data-bm-path="images/small/data.json"
      ...
      <div class="row">
            ...
            <div class="iq-card-body">
                ...
                <div class="col-sm-8">
                  <div class="media-sellers">
                    <div class="media-sellers-img">
                      <img src="@/assets/images/page-img/01.jpg" class="mr-3 rounded" alt="" />
                    </div>
              ...
              <div class="row mt-4">
                <div class="col-sm-8">
                  <div class="media-sellers">
                    <div class="media-sellers-img">
                      <img src="@/assets/images/page-img/02.jpg" class="mr-3 rounded" alt="" />
                    </div>
                    <div class="media-sellers-media-info">
              ...
              <div class="row mt-4">
                <div class="col-sm-8">
                  <div class="media-sellers">
                    <div class="media-sellers-img">
                      <img src="@/assets/images/page-img/03.jpg" class="mr-3 rounded" alt="" />
                    </div>
                    <div class="media-sellers-media-info">
              ...
              <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                ...
                <div class="iq-card-body">
                  ...
                  <div class="media-support">
                    <div class="media-support-header mb-2">
                      <div class="media-support-user-img mr-3">
                        <img class="rounded-circle" src="@/assets/images/user/02.jpg" alt="" />
                      </div>
                      <div class="media-support-info mt-2">
                  ...
                  <div class="media-support">
                    <div class="media-support-header mb-2">
                      <div class="media-support-user-img mr-3">
                        <img class="rounded-circle" src="@/assets/images/user/03.jpg" alt="" />
                      </div>
                      <div class="media-support-info mt-2">
                  ...
                  <div class="media-support">
                    <div class="media-support-header mb-2">
                      <div class="media-support-user-img mr-3">
                        <img class="rounded-circle" src="@/assets/images/user/04.jpg" alt="" />
                      </div>
                      <div class="media-support-info mt-2">
                    ...
                    <div class="col-lg-6">
                      <div class="p-4">
                        <div class="d-flex align-items-center">
                          ...
                          <h4 class="mb-0">
                            <span class="counter">200</span>k<small class="d-block font-size-14"
                              >Posts</small
                            >
                          </h4>
                        </div>
                    ...
                    <div class="col-lg-6">
                      <div class="p-4">
                        <div class="d-flex align-items-center">
                          ...
                          <h4 class="mb-0">
                            <span class="counter">400</span>k<small class="d-block font-size-14"
                              >Tweets</small
                            >
                          </h4>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="iq-card-body">
              <ul class="iq-timeline">
                ...
                <li>
                  ...
                  <div class="d-inline-block w-100">
                    <p>
                      Bonbon macaroon jelly beans <a href="#">gummi bears</a>gummi bears jelly
                      lollipop apple
                    </p>
          ...
          <div class="iq-card">
            <img src="@/assets/images/small/img-1.jpg" class="img-fluid w-100 rounded" alt="#" />
            <div class="iq-card-header d-flex justify-content-between">
              <div class="iq-header-title">
